describe('Facilities', () => {
  ...
  it('Enables search input initially', () => {
    cy.get('[data-cy=search-facilities-btn]').should('not.be.disabled')
  })

  it('Hides page selector initially', () => {
    cy.get('[data-cy=result-page-selector]').should('not.exist')
  })
  
  it('Shows facility list after search', () => {
    cy.get('[data-cy=search-facilities-btn]').click()
    cy.get('[data-cy=facility-list]').should('exist')
  })

  it('Shows page selector after search', () => {
